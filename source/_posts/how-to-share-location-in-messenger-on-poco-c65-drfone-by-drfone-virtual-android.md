---
title: How to Share Location in Messenger On Poco C65? | Dr.fone
date: 2024-08-01T23:42:13.164Z
updated: 2024-08-02T23:42:13.164Z
tags: 
...
categories:
  - android
description: This article describes How to Share Location in Messenger On Poco C65?
excerpt: This article describes How to Share Location in Messenger On Poco C65?
keywords: fake location on C65,fake location on android,fake gps location on android,change location on C65,change gps location on android,change location on android
...
## How to Change Google Play Location On Poco C65
...
Through your Poco C65s, you can change the location on both Google Play Store and Google Account easily. To know more details about **how to change the country in Google Play Store**, read the following guidelines:

**Step 1:** Open your Google Play Store from your Poco C65. Navigate to the profile icon from the corner and select "Settings" from the displayed menu.
...
In this particular situation, you don’t have to **change the** **Play** **Store** **country**; instead, you can only **change** **the** **Google** **location** on your Poco C65. We will recommend the [VPN Proxy Master Lite](https://play.google.com/store/apps/details?id=free.vpn.unblock.fast.proxy.vpn.master.pro.lite&hl=en&gl=US), which works effortlessly to **change** **Google**'s **location**. This tool flawlessly hides your IP address so that you can easily use any country's location to access all the applications and services. Moreover, it's highly secured and well-protected so that no virus can harm your Poco C65.
...
**Step 1:** Start installing VPN Proxy Master Lite on your Poco C65 from your Google Play Store. Once this app is successfully installed, open this app to proceed.
...
## Complete Tutorial to Use GPS Joystick to Fake GPS Location On Poco C65
...
- Take your Poco C65 handy and launch the “Settings”.
...
First, you need to make sure that the Google Play Services app installed over your Poco C65 is running on version 12.6.85 or lower. If that’s the case, you no longer require performing the lengthy steps below. Instead, directly skip stepping number 7 below.
