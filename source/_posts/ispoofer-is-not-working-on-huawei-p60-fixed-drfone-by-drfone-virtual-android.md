---
title: iSpoofer is not working On Huawei P60? Fixed | Dr.fone
date: 2024-05-20T09:33:27.401Z
updated: 2024-05-21T09:33:27.401Z
tags: 
...
keywords: change gps location on android,fake location on P60,change location on android,fake gps location on android,fake location on android,change location on P60
...
## 4 Methods to Turn off Life 360 On Huawei P60 without Anyone Knowing
...
### 2\. **Turn off Your Huawei P60’s Airplane Mode**
...
You’re not left out of this option; below are the steps to disable GPS service on your Huawei P60s.
...
- If you want to disable GPS services on your Huawei P60, turn off location tracking for apps.
...
### 2\. **Can Life360 track my location when I switch My Huawei P60 off?**
...
## Can Life360 Track Or See Text Messages? What Can You Do with Life360 On Huawei P60?
...
There are many valuable features in the life360 app, such as device tracking and locator, which allows you to track your stolen or lost devices. It also allows users to track what other circle members like to do, which route they prefer, and which locations they usually visit. Unfortunately, the app only runs when the location services on any device are turned on, and the user permits it to run in the background. It does not work when the Huawei P60 device is turned off, or its battery is dead.
...
**1\. Location:** Life360 can track the real-time location of the Huawei P60 devices associated with the app. This includes the ability to view the current whereabouts of family members on a map and track their movements over time.
...
**4\. Crash detection:** Life360 also includes a crash detection feature that uses sensors in the Huawei P60 device to detect potential car accidents. In such cases, the app can automatically send alerts to emergency contacts.
...
**6\. Battery level:** Life360 may have access to the battery level of the Huawei P60 devices connected to the app. This information can be used to provide alerts when a family member's device is low on battery.
